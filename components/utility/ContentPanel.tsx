                        ...
                        <div>
                          ...
                          >
                            <div className="grid grid-cols-6  sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 ">
                              ...
                              <div className=" pt-3 col-start-5 col-span-2 flex justify-end  sm:col-start-4 md:col-start-4 md:col-span-2  lg:col-start-5 lg:flex lg:justify-center  xl:col-start-2 xl:col-span-3 xl:flex xl:justify-center xl:pt-3">
                            ...
                            <div>
                              ...
                              >
                                <div className="grid grid-cols-5  sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 ">
                                  ...
                                  <div className="pt-3 col-start-4 col-span-2 flex justify-end sm:col-start-4 md:col-start-4 md:col-span-2  lg:col-start-5  xl:col-start-2 xl:col-span-3 xl:flex xl:justify-center xl:pt-3">
                                    <div className=" lg:grid lg:grid-rows-3 xl:grid-rows-1">
                                      <div className="  lg:row-start-2">
                                        {" "}
                                        <Box
